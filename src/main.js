class Building {
    ...
    get toString() {
        if (cheats)
            return `${this.name}: ${Math.round((this.getAmount > 0 ? this.getOutput / (this.getAmount + 1) : this.baseProduction) / this.getPrice * 100000) / 100}<br />🍪 ${formatNumber(Math.ceil(this.getPrice))}`;
        else
